...
int main(int argc, char** argv) {
    ...
    cudaMemcpy(hostOutput, deviceOutput, inputLength * sizeof(float), cudaMemcpyHostToDevice);
...
int main(int argc, char** argv) {
    ...
    wbTime_start(Compute, "Performing CUDA computation");
    vecAdd << <blockDim, gridDim >> > (deviceInput1, deviceInput2, deviceOutput, inputLength);
